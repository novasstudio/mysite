...
export const metadata: Metadata = { title: "Terms of Service", description: "Terms governing the use of LaunchPlay websites and games.", alternates: { canonical: "/terms/" }, openGraph: { title: "Terms of Service | LaunchPlay", description: "Terms governing the use of LaunchPlay websites and games.", url: "/terms/" } };
export default function Terms() { return <LegalLayout label="LEGAL" title="Terms of Service" updated="September 17, 2026">
  ...
  <h2>Contact</h2><p>Questions about these terms may be sent to <a href="mailto:hello@launchplay.ai">hello@launchplay.ai</a>.</p>
