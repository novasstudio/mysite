...
export const metadata: Metadata = { title: "Privacy Policy", description: "LaunchPlay studio privacy policy." };
export default function Privacy() { return <LegalLayout label="LEGAL" title="Privacy Policy" updated="September 17, 2026">
  ...
  <h2>Contact</h2><p>For privacy questions, email <a href="mailto:hello@launchplay.games">hello@launchplay.games</a>.</p>
